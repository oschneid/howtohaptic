...
Haptics has a long history, from **example** to **more recent example**.
...
3. **What are the Haptic Senses?** (Chapter \@ref(senses)) gives a brief overview of the sense of touch, with links to references
